...
I've included an example comparing agentic vs non-agentic approaches. As demonstrated by many others, combining the efforts of distributed task specific workers yields much higher quality and more relevant output. This is at the cost of some speed, as the aggregating `Researcher` Mule takes 1-3x the time of `Thinker` alone.
